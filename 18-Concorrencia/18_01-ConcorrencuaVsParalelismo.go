...
concorrência => padrao, forma de organizar as coisas (rodando independente uma das outras)
paralelismo => ocorre quando temps codigos corrente, rodando um computador varios processadores
*/
